...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if(nextConfirmBtn.getText().equals("Confirm") || checker.equals("Code Sent")){
                    ...
                    if(phoneNumber.equals("")){
                        ...
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber,60,TimeUnit.SECONDS,MainActivity.this,callBack);        // OnVerificationStateChangedCallbacks
                    }
                }
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(MainActivity.this,overallTabbedActivity.class);
                            startActivity(i);
                            finish();
                        } else {
                            loadingBar.dismiss();
                            Toast.makeText(MainActivity.this,"Error: Enter a valid code",Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    // Code From Here is for Testing Purpose Only .................
